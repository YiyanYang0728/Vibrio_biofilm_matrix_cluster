...
foreach $id (@ids) {
  ...
  if (50) {
    $cmd = `blastp -outfmt 6 -db ./all_pro.faa_40.1353925 -seg yes -evalue 0.000001 -max_target_seqs 100000 -num_threads 1 -query all_pro.faa_40-seq/$id -out all_pro.faa_40-bl/$id`;
    ...
    $cmd = `blastp -outfmt 6 -db ./all_pro.faa_40.1353925 -seg yes -evalue 0.000001 -max_target_seqs 100000 -num_threads 1 -query all_pro.faa_40-seq/$id | /usr/local/apps/cd-hit/cdhit-4.8.1/psi-cd-hit/psi-cd-hit.pl -J parse_blout all_pro.faa_40-bl/$id -c .30000000000000000000 -ce -1 -aS 0 -aL 0 -G 1 -prog blastp -bs 1`;
  }
  else {
    $cmd = `blastp -outfmt 6 -db ./all_pro.faa_40.1353925 -seg yes -evalue 0.000001 -max_target_seqs 100000 -num_threads 1 -query all_pro.faa_40-seq/$id -out all_pro.faa_40-bl/$id`;
